...
$query_DatosConsulta = sprintf("SELECT * FROM pedido Where Estado = 'Completado'");
...
<div class="row">
		...
		//AQUI ES DONDE SE SACAN LOS DATOS, SE COMPRUEBA QUE HAY RESULTADOS
			 ...
			 do { 
				...
				<tr>
						<td><?php echo $row_DatosConsulta["idPedido"];?></td>
						<td><?php echo $row_DatosConsulta["idUsuario"];?></td>
						<td><?php echo $row_DatosConsulta["FechaInicio"];?></td>
						<td><?php echo $row_DatosConsulta["FechaEstimada"];?></td>
						<td><?php echo $row_DatosConsulta["Estado"];?></td>
